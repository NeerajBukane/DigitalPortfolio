...
sr.reveal('.home__img',{delay: 1500}); 
sr.reveal('.home__content',{delay: 1400}); 
sr.reveal('.home__social-icon',{ interval: 1100}); 
...
/*SCROLL QUAL*/
sr.reveal('.qual__tabs',{interval: 200}); 
sr.reveal('.qual__sections',{interval: 200}); 


/*SCROLL SERVICES*/
sr.reveal('.services__container',{interval: 200}); 
// sr.reveal('.button',{interval: 200}); 
// sr.reveal('.services__content2',{interval: 200}); 
// sr.reveal('.portfolio__button',{interval: 200}); 
